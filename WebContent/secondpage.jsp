...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#portfolio">Holdings</a>
			</li>
		...
		<div class="tab-content">
			<div id="portfolio" class="tab-pane fade in active">
				...
				<div class="container">
					<img class="mySlides" src="linegraph.png"> <img
						class="mySlides" src="piechart.png"> <img class="mySlides"
						src="PriceChange.png">
					...
					<a href="load-portfolio"><h2>Holdings</h2></a>
